...
export const DirectoryMainPage = (): JSX.Element => {
    ...
    return (
        <div
            className="relative w-full min-w-full bg-[#050505] overflow-hidden flex flex-col"
            data-model-id="1:2"
        >
            ...
            <div className="-mt-16 sm:-mt-20 lg:-mt-24 relative z-40">
            ...
            <div className="flex flex-col mt-16 sm:mt-20 lg:mt-24">
            ...
            <div className="px-4 sm:px-6 lg:px-10 mt-6 sm:mt-8 lg:mt-[35px]">
